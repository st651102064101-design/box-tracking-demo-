...
export function epcToAscii(epcHex) {
    ...
    if (body.length < 2)
        return null; // one character is noise, not a code
    for (const b of body) {
        if (b < 0x20 || b > 0x7e)
            return null; // printable ASCII only
    }
 ...
 * it names a real box.
 */
export function epcTagCandidates(epcHex) {
...
//# sourceMappingURL=epcCodec.js.map