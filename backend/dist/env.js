...
export const env = {
    ...
    line: {
        ...
        autoNotificationsEnabled: String(process.env.AUTO_LINE_NOTIFICATIONS_ENABLED ?? 'true').toLowerCase() === 'true',
        ...
        autoEmailNotificationsEnabled: String(process.env.AUTO_EMAIL_NOTIFICATIONS_ENABLED ?? 'true').toLowerCase() === 'true',
    },
