...
/// Covers the "floor exception" screens added alongside
/// POST /api/boxes/:tag/hold: HoldReleaseScreen, and LocationInquiryScreen
/// (the client-side reverse of "หากล่อง"). Each is driven the way the
/// imager actually feeds them —
