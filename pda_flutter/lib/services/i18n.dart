...
class LocaleController extends ChangeNotifier {
  ...
  static const Map<String, String> _dict = {
    ...
    'ยิงบาร์โค้ดเพื่อทำการเชื่อมต่อ': 'Scan a barcode to connect',
    'สแกน QR เชื่อมต่อด้วยกล้อง': 'Scan the connect QR with the camera',
    'เปิดกล้องสแกน': 'Open camera scanner',
    'สแกนด้วยกล้อง': 'Scan with camera',
