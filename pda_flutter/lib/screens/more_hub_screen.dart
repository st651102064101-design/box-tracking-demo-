          ...
          child: ListView(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  loc.t('แจ้งกล่องชำรุด — ทำได้ตอนรับเข้า (Gate In): ติ๊กสถานะ "ชำรุด" ที่การ์ดกล่องนั้นในคิวก่อนยืนยัน'),
                  style: TextStyle(fontSize: 12, color: C.orange, height: 1.45, fontWeight: FontWeight.w600),
                ),
              ),
            ],
          ),
