...
const nextConfig = {
  ...
  // Serve the large standalone 3D module raw. A few LAN Edge clients were
  // receiving a truncated gzip stream and therefore reporting an EOF parse
  // error even though the source file itself was valid.
  compress: false,
  async rewrites() {
